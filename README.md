<!--
**hcwang24/hcwang24** is a ✨ _special_ ✨ repository because its `README.md` (this file) appears on your GitHub profile.
...
|------------------|-----------------------------|-------------------------|-------------------------------------------|----------------|
| **Movie Review Sentiment Analysis**      | Developed a Natural Language Processing (NLP) and machine learning model to analyze the sentiment of movie reviews.   | [GitHub Link](https://github.com/hcwang24/Movie-Review-Sentiment-Analysis)                              | Python Dash, NLP, nltk, spacy                    | NLP, Sentiment Analysis     |
...
| **Superstore Sales in 2014-2017**         | Developed a Tableau Storyboard analysis deciphering profits and losses of Superstore between 2014 and 2017 in the US.   | [Tableau Story](https://public.tableau.com/views/SuperstoreSales_17434475674450/Storyboard?:language=en-US&:sid=&:redirect=auth&:display_count=n&:origin=viz_share_link) | Tableau      | Finance         |
