...
| **Credit Card Default Prediction**   | Built a machine learning model using <span style="color:#8B0000;">LightGBM</span> to predict customer credit defaults, achieving 90% accuracy.                                  | [GitHub Link](https://github.com/) | <span style="color:#3572A5;">Python</span>, <span style="color:#8B0000;">LightGBM</span>, <span style="color:#3572A5;">Python</span> | <span style="color:#FFD700;">Finance</span> |
